...
Это решение [проблемы отслеживания IP-адресов на Frontend Mentor](https://www.frontendmentor.io/challenges/ip-address-tracker-I8-0yYAH0). Это первое испытания, которое я прошел в дальнейшем есть желания проходить подобные испытания чаще. Приятного ознакомления:)
...
- Поиск любых IP-адресов и просмотр ключевой информации и местоположения
